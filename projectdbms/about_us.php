...
<body>
<div id="history">
<p class="p1">IIIT ALLAHABAD alumni management system </p>
<p class="p3">The IIIT ALLAHABAD alumni management system supervises the graduate programs in IIITA. 
...
<p class="p2">FUNCTION OF  IIIT ALLAHABAD ALUMNI  MANAGEMENT  SYSTEM </p>
<p class="p3">The function of IIIT ALLAHABAD alumni management system includes the following:
<ul class="ul2">
